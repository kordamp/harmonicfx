...
import eu.hansolo.fx.circularplot.tools.Helper;
import eu.hansolo.fx.circularplot.tools.Point;
...
public class CircularPlot extends Region {
    ...
    // ******************** Constructors **************************************
    public CircularPlot() {
        getStylesheets().add(CircularPlot.class.getResource("circular-plot.css").toExternalForm());
    ...
    private void drawChart() {
        ...
        for (int i = 0 ; i < noOfItems ; i++) {
            ...
            double itemNamePointX = centerX + chartSize * 0.57 * sinValue;
            double itemNamePointY = centerY + chartSize * 0.57 * cosValue;
