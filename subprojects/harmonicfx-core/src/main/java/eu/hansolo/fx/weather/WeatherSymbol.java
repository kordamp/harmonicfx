...
public class WeatherSymbol extends Region {
    ...
    // ******************** Constructor ***************************************
    public WeatherSymbol(final Condition CONDITION, final double SIZE, final Color COLOR) {
        condition   = new ObjectPropertyBase<Condition>(null == CONDITION ? Condition.NONE : CONDITION) {
        ...
        symbolColor = new StyleableObjectProperty<Color>(null == COLOR ? Color.WHITE : COLOR) {
            @Override public Object getBean() { return WeatherSymbol.this; }
        ...
        size        = SIZE;
        getStylesheets().add(WeatherSymbol.class.getResource("weatherfx.css").toExternalForm());
        initGraphics();
        registerListeners();
    }
    ...
    public final Condition getCondition() { return condition.get(); }
    public final void setCondition(final Condition CONDITION) { condition.set(CONDITION); }
    public final ObjectProperty<Condition> conditionProperty() { return condition; }
